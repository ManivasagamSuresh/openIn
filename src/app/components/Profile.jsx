...
function Profile({profile}) {
  ...
  return (
    <div className='flex flex-col sm:justify-around h-56 sm:h-full py-8 px-5 gap-5'>
        <div className={`text-2xl ${monteserat.className} font-bold px-5`}>{profile.name}</div>
        <div className='flex flex-col sm:flex-row gap-3'>
            ...
            <div className='flex items-center justify-center gap-3'>
                ...
                <div className={`text-sm ${monteserat.className}`}>{profile.phone}</div>
            </div>
            <div className='flex items-center justify-center gap-3'>
                <div className='p-1 bg-mailBg rounded-full text-mail'><FiMail/></div>
                <div className={`text-sm ${monteserat.className}`}>{profile.email}</div>
            </div>
            </div>
            ...
            <div className='p-1 bg-instaBg rounded-full text-insta'><BsInstagram/></div>
                <div className={`text-sm ${monteserat.className}`}>{profile.instagram}</div>
            </div>

            <div className=' flex items-center justify-center gap-3'>
                <div className='p-1 bg-youtubeBg rounded-full text-youtube'><AiOutlineYoutube/></div>
                <div className={`text-sm ${monteserat.className}`}>{profile.youtube}</div>                
            </div>
            </div>
