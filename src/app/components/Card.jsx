  ...
  return (
    <div className='flex gap-8 flex-wrap'>
        <div className='bg-white w-full sm:w-5/12  lg:flex-1 rounded-xl flex flex-col gap-3 py-4 px-7 shadow-xl '>
            <div className='rounded-full h-10 w-10 relative overflow-hidden bg-lightGreen flex items-center justify-center'><Image src="/revenue.png" height={27} width={27}  className=''/></div>
            <div className={`${lato.className} text-sm`}>Total revenues</div>
            <div className='flex justify-between'>
                <div className={`font-bold ${openSans.className} text-xl`}>$2,129,430</div>
        ...
        <div className='bg-white w-full sm:w-5/12  lg:flex-1  rounded-xl flex flex-col gap-3 py-4 px-7 shadow-xl'>
            ...
            <div className={`${lato.className} text-sm`}>Total Transactions</div>
            <div className='flex justify-between'>
                <div className={`font-bold ${openSans.className} text-xl`}>1,520</div>
        ...
        <div className='bg-white w-full sm:w-5/12  lg:flex-1 rounded-xl flex flex-col gap-3 py-4 px-7 shadow-xl'>
            ...
            <div className={`${lato.className} text-sm`}>Total Likes</div>
            <div className='flex justify-between'>
                <div className={`font-bold ${openSans.className} text-xl`}>9,721</div>
        ...
        <div className='bg-white w-full sm:w-5/12  lg:flex-1 rounded-xl flex flex-col gap-3 py-4 px-7 shadow-xl'>
            ...
            <div className={`${lato.className} text-sm`}>Total users</div>
            <div className='flex justify-between'>
                <div className={`font-bold ${openSans.className} text-xl`}>9,721</div>
